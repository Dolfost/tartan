...
This is a platform-agnostic set of scripts for countinuous integration and
deployment. There is platform-specific setup scripts in folder with this
...
variable `REPO` to the full path to repository root. Corresponding CMake
scripts use it for running commands.
